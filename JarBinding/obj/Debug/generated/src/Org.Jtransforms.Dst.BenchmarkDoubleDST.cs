...
namespace Org.Jtransforms.Dst {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.jtransforms.dst']/class[@name='BenchmarkDoubleDST']"
	[global::Android.Runtime.Register ("org/jtransforms/dst/BenchmarkDoubleDST", DoNotGenerateAcw=true)]
	public partial class BenchmarkDoubleDST : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/jtransforms/dst/BenchmarkDoubleDST", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BenchmarkDoubleDST); }
		}

		protected BenchmarkDoubleDST (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_benchmarkForward_1D;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dst']/class[@name='BenchmarkDoubleDST']/method[@name='benchmarkForward_1D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dst']/class[@name='BenchmarkDoubleDST']/method[@name='benchmarkForward_2D_input_1D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dst']/class[@name='BenchmarkDoubleDST']/method[@name='benchmarkForward_2D_input_2D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dst']/class[@name='BenchmarkDoubleDST']/method[@name='benchmarkForward_3D_input_1D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dst']/class[@name='BenchmarkDoubleDST']/method[@name='benchmarkForward_3D_input_3D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dst']/class[@name='BenchmarkDoubleDST']/method[@name='main' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dst']/class[@name='BenchmarkDoubleDST']/method[@name='parseArguments' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
