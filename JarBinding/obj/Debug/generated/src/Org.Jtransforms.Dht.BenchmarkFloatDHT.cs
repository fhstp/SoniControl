...
namespace Org.Jtransforms.Dht {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.jtransforms.dht']/class[@name='BenchmarkFloatDHT']"
	[global::Android.Runtime.Register ("org/jtransforms/dht/BenchmarkFloatDHT", DoNotGenerateAcw=true)]
	public partial class BenchmarkFloatDHT : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/jtransforms/dht/BenchmarkFloatDHT", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BenchmarkFloatDHT); }
		}

		protected BenchmarkFloatDHT (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_benchmarkForward_1D;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dht']/class[@name='BenchmarkFloatDHT']/method[@name='benchmarkForward_1D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dht']/class[@name='BenchmarkFloatDHT']/method[@name='benchmarkForward_2D_input_1D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dht']/class[@name='BenchmarkFloatDHT']/method[@name='benchmarkForward_2D_input_2D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dht']/class[@name='BenchmarkFloatDHT']/method[@name='benchmarkForward_3D_input_1D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dht']/class[@name='BenchmarkFloatDHT']/method[@name='benchmarkForward_3D_input_3D' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dht']/class[@name='BenchmarkFloatDHT']/method[@name='main' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jtransforms.dht']/class[@name='BenchmarkFloatDHT']/method[@name='parseArguments' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
