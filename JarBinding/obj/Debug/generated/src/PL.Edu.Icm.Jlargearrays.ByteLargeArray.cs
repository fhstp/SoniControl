...
namespace PL.Edu.Icm.Jlargearrays {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']"
	[global::Android.Runtime.Register ("pl/edu/icm/jlargearrays/ByteLargeArray", DoNotGenerateAcw=true)]
	public partial class ByteLargeArray : global::PL.Edu.Icm.Jlargearrays.LargeArray {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("pl/edu/icm/jlargearrays/ByteLargeArray", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ByteLargeArray); }
		}

		protected ByteLargeArray (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/constructor[@name='ByteLargeArray' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public unsafe ByteLargeArray (byte[] p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ByteLargeArray)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/constructor[@name='ByteLargeArray' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='byte']]"
		[Register (".ctor", "(JB)V", "")]
		public unsafe ByteLargeArray (long p0, sbyte p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/constructor[@name='ByteLargeArray' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='boolean']]"
		[Register (".ctor", "(JZ)V", "")]
		public unsafe ByteLargeArray (long p0, bool p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/constructor[@name='ByteLargeArray' and count(parameter)=1 and parameter[1][@type='long']]"
		[Register (".ctor", "(J)V", "")]
		public unsafe ByteLargeArray (long p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='get' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getBoolean' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getBooleanData' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getBooleanData' and count(parameter)=4 and parameter[1][@type='boolean[]'] and parameter[2][@type='long'] and parameter[3][@type='long'] and parameter[4][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getByte' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getByteData' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getByteData' and count(parameter)=4 and parameter[1][@type='byte[]'] and parameter[2][@type='long'] and parameter[3][@type='long'] and parameter[4][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getData' and count(parameter)=0]"
		[Register ("getData", "()[B", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getDouble' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getDoubleData' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getDoubleData' and count(parameter)=4 and parameter[1][@type='double[]'] and parameter[2][@type='long'] and parameter[3][@type='long'] and parameter[4][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getFloat' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getFloatData' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getFloatData' and count(parameter)=4 and parameter[1][@type='float[]'] and parameter[2][@type='long'] and parameter[3][@type='long'] and parameter[4][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getFromNative' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getInt' and count(parameter)=1 and parameter[1][@type='long']]"
		[Register ("getInt", "(J)I", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getIntData' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getIntData' and count(parameter)=4 and parameter[1][@type='int[]'] and parameter[2][@type='long'] and parameter[3][@type='long'] and parameter[4][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getLong' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getLongData' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getLongData' and count(parameter)=4 and parameter[1][@type='long[]'] and parameter[2][@type='long'] and parameter[3][@type='long'] and parameter[4][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getShort' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getShortData' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getShortData' and count(parameter)=4 and parameter[1][@type='short[]'] and parameter[2][@type='long'] and parameter[3][@type='long'] and parameter[4][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='getUnsignedByte' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setBoolean' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='boolean']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setByte' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='byte']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setDouble' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='double']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setFloat' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='float']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setInt' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setLong' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setShort' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='short']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setToNative' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='java.lang.Object']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='pl.edu.icm.jlargearrays']/class[@name='ByteLargeArray']/method[@name='setUnsignedByte' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='short']]"
